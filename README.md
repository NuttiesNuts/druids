...
- [More RPG Library](https://modrinth.com/mod/more-rpg-library 'Title')
...
All spells are defined in data files, hence customizable via data packs. Find the original data files in the project source linked to this page.

Item attributes of druid equipment and other tweaks can be configured by changing config JSON files under `config/druids/`

## ✨ Discover more RPG-Content created by other Spell Engine devs

[![Mercenaries and Artificers](https://media.forgecdn.net/attachments/1346/857/merc_275-png.png)](https://www.curseforge.com/minecraft/mc-mods/mercenaries-and-artificers)
[![Elemental Wizards](https://media.forgecdn.net/attachments/1370/711/elemental_wizards_275-png-png.png)](https://modrinth.com/mod/elemental-wizards-rpg)
[![Death Knigths](https://media.forgecdn.net/attachments/953/998/death_knights_275_2.png)](https://modrinth.com/mod/death-knights)
